    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<RegisterResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        var user = new User
        {
            ...
            UserRoles =
            [
                new AuthServiceIN6BM.Domain.Entities.UserRole
                {
                    Id = userRoleId,
                    UserId = userId,
        ...
        return new RegisterResponseDto
        {
            ...
            EmailVerificationRequiered = true
        };
    }
    ...
    {
        var user = await userRepository.GetByEmailVerficationTokenAsync(verifyEmailDto.Token);
