...
public class PasswordHashService : IPasswordHashService
{
    ...
    public bool VerifyPassword(string password, string hashedPassword)
    {
        try
        {
            ...
            {
                Console.WriteLine("[DEBUG] Using Argon2 standard format verifications");
                var result = VerifyArgor2StandardFormat(password, hashedPassword);
    ...
    private bool VerifyArgor2StandardFormat(string password, string hashedPassword)
    {
        try
        {
